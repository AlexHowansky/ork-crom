...
/**
 * Assertion to verify that a column has at least a given length.
 */
class ColumnHasLengthAtLeastAssertion extends AbstractAssertion
{

    /**
     * Use this configuration field when building the label.
     */
    protected const LABEL_EXTRA_FIELD = 'length at least';
