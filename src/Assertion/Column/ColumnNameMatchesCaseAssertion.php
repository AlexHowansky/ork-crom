...
/**
 * Assertion to verify that a column name matches a particular casing strategy.
 */
class ColumnNameMatchesCaseAssertion extends AbstractNameMatchesCaseAssertion
{
