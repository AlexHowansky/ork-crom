...
/**
 * Assertion to verify that a column is a primary key.
 */
class ColumnIsPrimaryKeyAssertion extends AbstractAssertion
{
    ...
    {
        return $asset->getTable()->getPrimaryKey()?->spansColumns([$asset->getName()]) ?? false;
    }
