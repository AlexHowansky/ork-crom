...
/**
 * Assertion to verify that a column is autoincrement.
 */
class ColumnIsAutoincrementAssertion extends AbstractAssertion
{
    ...
    {
        return $asset->getColumn()->getAutoincrement();
    }
